...
\newpagestyle{main}{
\setfootrule{0.4pt}
\setfoot{}{\thepage}{Домашняя работа \ № \ 8}}
\pagestyle{main}
% \pagecolor{mycolor}

Найти кривизну для поверхности $z = \cfrac{1}{2} \inner{ax^2 + 2bxy + cy^2}$.
...
\begin{eqnarray}
    ...
    \begin{pmatrix}
        0 \\ 1 \\ b+cy
    \end{pmatrix}\\
    n = \cfrac{1}{\sqrt{1+\inner{ax+b}^2 + \inner{b+cy}^2}}
    \begin{pmatrix}
        -ax-b \\ -b-cy \\ 1
    \end{pmatrix}
\end{eqnarray}
...
\begin{gather}
    K_{ij} =\cfrac{1}{\sqrt{1 + \inner{ax+b}^2 + \inner{b+cy}^2}}
    \begin{pmatrix}
        a & b \\
        b & c
    \end{pmatrix}
    \vline_{x=0, \ y=0}
    =\cfrac{1}{\sqrt{1 + b^2 + c^2}}
    \begin{pmatrix}
        a & b \\
        b & c
    \end{pmatrix}
...
%Попробую найти индуцированную метрику:
%
%\begin{eqnarray}
%    \braket{e_x}{e_x} = 1 + f_x^2 = g_{11}\\
%    \braket{e_y}{e_y} = 1 + f_y^2 = g_{22}\\
%    \braket{e_x}{e_y} = f_y f_x = g_{12} = g_{21}\\
%\end{eqnarray}
%
%\begin{gather}
%    g_{ij} =
%    \begin{pmatrix}
%        1 + 4(ax+b)^2 & 4(ax+b)(b+cy)\\
%        4(ax+b)(b+cy) & 1 + 4(b+cy)^2
%    \end{pmatrix}
%\end{gather}
